...
class CliQualityFlowTests(Phase2TestCase):
    def test_extract_internal_map_flow(self) -> None:
        ...
        code, mapping = run_map(SimpleNamespace(path=str(self.workspace), source_id=source_id))
        ...
        self.assertTrue(mapping["persisted_candidates"])
